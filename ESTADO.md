...
- **veredicto:pantalla-principal** — última pasada confirmada: 34/40, 16/20 (craft YA pasa el umbral). Se aplicó una corrección más (botones a 48px, jerarquía de un solo CTA sólido por vez) y se relanzó el revisor una vez más — resultado de esa pasada final pendiente de esta misma sesión.
