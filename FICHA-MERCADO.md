# FICHA DE MERCADO — GymEvo

## Alcance de esta ficha
- Nicho/categoría exacta: apps de rutinas de entrenamiento estructuradas para gimnasios comerciales (no "fitness" genérico)
- País(es) donde se va a vender: LATAM (referencia Smart Fit/Bodytech — inicialmente México/Colombia/Brasil) · Moneda de cobro: USD (vía Hotmart, conversión automática por país)
- Fecha de investigación: 27/08/2026 (documento "INV MERC. PROP VALOR.pdf" entregado por el usuario) · **Vence el:** 27/02/2027
- Pasarela/plataforma de venta elegida: Hotmart — **cuenta aún NO creada** (pendiente de Sesión 6)
...
- **Análisis competitivo 25/09/2026**: ver docs/ANALISIS-DE-MERCADO-2026-09.md (Strong tiene la MISMA escalera 4.99/19.99/29.99; Fitbod 79.99-95.99/año; RP y Juggernaut 300-350; NTC y Gymshark gratis; MadMuscles 1.3/5 en Trustpilot por cobros; Smart Fit Colombia Black 119.900 COP/mes). Precios de reseñas: confirmar en oficial antes de publicar.
...
- ¿Se compra el mismo día o se piensa? NO ENCONTRADO — se decide por criterio: dado el trial de 7 días sin cobro inicial, se asume decisión de bajo riesgo, mayormente same-day · se revisa el 27/02/2027
- **Ventana mínima antes de declarar que una campaña fracasó:** 14 días (cubre el ciclo completo de trial + primer cobro)

## 3. CÓMO PAGA ESTE MERCADO (verificado, no supuesto)
- Medios de pago disponibles en el checkout REAL: NO ENCONTRADO — checkout de Hotmart aún no abierto (cuenta pendiente de creación, Sesión 6). Se revisa en cuanto exista la cuenta.
- Penetración de tarjeta de crédito / medios alternos (PIX, OXXO): NO ENCONTRADO — pendiente de Sesión 6
- **Consecuencia para el producto:** ninguna decisión de exclusión tomada todavía; se revisa al abrir el checkout real
...
- ⚠️ Antes de lanzar (Sesión 6/7): crear la cuenta Hotmart, configurar el producto con estos plazos exactos, y volver a esta ficha a llenar los campos NO ENCONTRADO con el dato real verificado en el panel.

## 5. CONVERSIÓN ESPERABLE — para saber si un número es malo o normal
- Conversión típica visita→registro del nicho: NO ENCONTRADO — se revisa el 27/02/2027 con datos propios
- Conversión típica prueba→pago del nicho: benchmark general de apps de fitness/hábitos con onboarding+trial: ~20-25% (Cal AI, fuente: 02B del sistema, no específico de este nicho) | fecha: referencia general, no medición propia
- **Umbral de muestra antes de decidir:** 200 sesiones al onboarding (criterio propio, sin dato de nicho específico)

## 6. ESTACIONALIDAD Y CONTEXTO
- ¿La demanda tiene picos? Sí — enero (propósitos de año nuevo), típico del nicho fitness | fuente: conocimiento general de la categoría, sin cifra propia
- Regulación que afecte la venta: ninguna identificada (no es salud regulada, no maneja datos médicos sensibles) — ver 47-LEGAL-FISCAL-Y-PRIVACIDAD.md si esto cambia
